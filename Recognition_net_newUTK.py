...
from cor_src.cor_network import cor_resnet34
...
parser.add_argument('--save_folder', default= './cor_RESULTS_comparison/Original/',type=str, help='Dir to save results')
...
if __name__ == '__main__':
    ...
    weights_path = r'cor_weights/newUTK/Adam__lr_0.0005__bs_20epoch_count200.pt'
    CORAL_net = cor_resnet34(NUM_CLASSES+1, False)
